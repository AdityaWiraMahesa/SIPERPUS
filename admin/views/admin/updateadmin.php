<h5 class="ml-2 mb-3"><i class="fas fa-user-cog mr-2"></i><b>UPDATE DATA ADMIN</b></h5>
<hr class="mb-4">
<form action="index.php?mod=admin&page=update" method="POST" enctype="multipart/form-data">
    <div class=" row">
        ...
        <div class="col-md-5 ml-5">
            ...
            <div class="form-group mt-3">
                ...
                <img src="../media/<?= $admin['photo'] ?>" width="100"><br>
            ...
            <div class="form-grup">
                ...
                <button type="submit" class="btn btn-danger ml-1 rounded-pill"><a href="http://localhost:8080/siperpus/admin/index.php?mod=admin" class="text-white"><i class="fas fa-arrow-circle-left mr-2"></i>Back</a></button>
            </div>
        </div>
    </div>
</form>
