...
<form action="index.php?mod=admin&page=update" method="POST">
    <div class="row">
        <div class="col-md-5">
            <div class="form-grup">
            ...
            <div class="form-grup mt-3">
                <input type="number" hidden name="id_admin" required value="<?= (isset($_POST['Id_Admin'])) ? $_POST['Id_Admin'] : ''; ?>" class="form-control">
